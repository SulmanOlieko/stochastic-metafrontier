...
#install.packages(c("devtools", "sfaR", "ggplot2", "cowplot","patchwork", "readxl", "dplyr", "gridExtra", "writexl", "stringr"))
library(devtools)
library(sfaR)
library(ggplot2)
library(cowplot)
...
library(readxl)
data_2 <- read_excel("~/data_2-2.xlsx", 
    sheet = "te_ee_data")
#View(data_2)
...
ggplot(LCM_te) +
  ...
  labs(x = "Posterior probability",
       ...
       fill = "Class") + 
  scale_fill_manual(values = c("2" = "darkgreen", "1" = "orange"), 
                    labels = c("2" = "Intensive", "1" = "Extensive")) + 
  scale_color_manual(values = c("2" = "darkgreen", "1" = "orange"), 
                     labels = c("2" = "Intensive", "1" = "Extensive"), 
                     guide = "none") + 
...
combined_adopters_nonadopters_plot <- ggplot(adopters_nonadopters_tgr, aes(x = tgr, fill = group)) +
  ...
  geom_vline(data = mean_adopters_nonadopters_tgr, aes(xintercept = mean_tgr), linetype = "dashed", color = c("darkgreen", "black")) + 
  theme_bw() +
...
combined_all_three_plot <- ggplot(all_three_tgr, aes(x = tgr, fill = group)) +
  ...
  geom_vline(data = mean_all_three_tgr, aes(xintercept = mean_tgr), linetype = "dashed", color = c("orange", "darkgreen", "black")) + 
  theme_bw() +
  labs(x = "TGR", y = "Density",
       title = "") +
...
combined_adopters_nonadopters_mte_plot <- ggplot(adopters_nonadopters_mte, aes(x = mte, fill = group)) +
  ...
  geom_vline(data = mean_adopters_nonadopters_mte, aes(xintercept = mean_mte), linetype = "dashed", color = c("darkgreen", "black")) + 
  theme_bw() +
...
combined_all_three_mte_plot <- ggplot(all_three_mte, aes(x = mte, fill = group)) +
  ...
  geom_vline(data = mean_all_three_mte, aes(xintercept = mean_mte), linetype = "dashed", color = c("orange","darkgreen","black")) + 
  theme_bw() +
  labs(x = "MTE", y = "Density", 
       title = "") +
  theme(axis.title.x = element_text(face = "bold", size = 16),
